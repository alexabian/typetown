...
export const TASKS_LIDIA = [
  ...
  { type: 'word_scramble', badge: 'Word Mix', title: 'Word Puzzle', prompt: 'Unscramble the word and type it:', points: 8, minCompleted: 12 },
  { type: 'vowel_choice', badge: 'Vowels', title: 'Word Helper', prompt: 'Pick the missing vowel to finish the word:', points: 7, minCompleted: 14 },
  { type: 'emoji_pattern', badge: 'Patterns', title: 'Sticker Pattern', prompt: 'What comes next in the pattern?', points: 8, minCompleted: 16 },
];
...
export const EASY_WORDS = ['cat', 'dog', 'sun', 'hat', 'pen', 'bag', 'egg', 'jam'];
